...
class Store extends Redirectifunauthenticated 
{
    ...
    public function index()
    {
        $this->parser->parse('templates/backend', [
            'content' => $this->load->view('backend/admin/store/index', isset($data) ? $data : null, true)
        ]);
    }
    ...
    {
        $this->parser->parse('templates/backend', [
            'content' => $this->load->view('backend/admin/store/form', isset($data) ? $data : null, true)
        ]);
    }
