...
class Product extends Redirectifunauthenticated 
{
    ...
    public function index()
    {
        $this->parser->parse('templates/backend', [
            'content' => $this->load->view('backend/admin/product/index', isset($data) ? $data : null, true)
        ]);
    }
    ...
    {
        $this->parser->parse('templates/backend', [
            'content' => $this->load->view('backend/admin/product/form', isset($data) ? $data : null, true)
        ]);
    }
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            // logging in process
            redirect('backend/admin/product');
        }
    }
