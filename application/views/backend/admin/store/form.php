        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if(isset($store)): ?>
                        <form method="POST" action="<?php echo base_url('backend/admin/store/update/'. $store->id) ?>" enctype="multipart/form-data">
                    <?php else: ?>
                        <form method="POST" action="<?php echo base_url('backend/admin/store/store') ?>" enctype="multipart/form-data">
                    <?php endif ?>
                        ...
                        <div class="text-right">
                            <a href="<?php echo base_url('backend/admin/store') ?>" class="btn btn-secondary"><i class="fa fa-times"></i> Cancel</a>
