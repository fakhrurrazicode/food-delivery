        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if(isset($product)): ?>
                        <form method="POST" action="<?php echo base_url('backend/admin/product/update/'. $product->id) ?>" enctype="multipart/form-data">
                    <?php else: ?>
                        <form method="POST" action="<?php echo base_url('backend/admin/product/store') ?>" enctype="multipart/form-data">
                    <?php endif ?>
